    ...
    <div className="grid h-screen w-full pl-[53px]">
      <aside className="inset-y fixed left-0 z-20 flex h-full flex-col border-r">
        <div className="border-b p-2">
          ...
          >
            <Image src="/diya.png" alt="logo" width={28} height={28} />
          </Button>
        </div>
      ...
      <div className="flex flex-col">
        <header className="sticky top-0 z-10 flex h-[53px] items-center gap-1 border-b bg-background px-4">
          <h1 className="text-xl font-semibold">Hackathon Playground</h1>
          <Drawer>
          ...
          <Button variant="outline" size="icon" className="text-sm" title="GitHub Repo" asChild>
            <Link
              href="https://github.com/diyakamboj"
              target="_blank"
            >
