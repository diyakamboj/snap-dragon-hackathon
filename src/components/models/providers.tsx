...
export function Providers() {
  ...
  async function handleChat() {
    ...
    try {
      ...
      console.log(`Response from AI Provider ${providerModel} API Response: ${JSON.stringify(response, null, 2)}`);
      ...
      console.error(`Error occurred in handleChat() function: ${error}`);
    } finally {
      setLoading(false);
    }
  }
