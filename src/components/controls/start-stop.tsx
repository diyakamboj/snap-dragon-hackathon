...
export function StartStop() {
  ...
  return (
    <div className="relative space-x-1">
      <Button onClick={grab} variant="ghost" size="icon" title="Play">
        <PlayIcon className="size-4" />
      </Button>
      <Button onClick={stop} variant="ghost" size="icon" title="Stop">
        <SquareIcon className="size-4" />
      </Button>
      <Button onClick={stop} variant="ghost" size="icon" title="Restart">
